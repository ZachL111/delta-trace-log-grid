...
delta-trace-log-grid is a Scala project for observability. It focuses on this technical goal: Package a Scala local lab for log analysis with round-trip fixtures, lossless normalization checks, and documented operating limits.
