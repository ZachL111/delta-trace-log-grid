"""Regression checks for the delta-trace-log-grid casebook."""
...
from casebook.harness import assert_expected, delta_trace_log_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(delta_trace_log_grid_summary(), assert_expected())
